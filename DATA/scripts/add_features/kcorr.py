...
kc = Kcorrect(responses = responses, abcorrect= False, redshift_range= [0., 3.], nredshift = 5000, cosmo= FlatLambdaCDM(H0=70, Om0=0.3))
...
# edited kcorrect to return errors (rnorm)
