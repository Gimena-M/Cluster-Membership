...
mag_lims = dict(
    g_cmodel_mag = [19, 20, 21, 22, 23, 24, 25, 26, 27], 
    r_cmodel_mag = [17, 18, 19, 20, 21, 22, 23, 24, 25],
    i_cmodel_mag = [17, 18, 19, 20, 21, 22, 23, 24, 25],
    z_cmodel_mag = [17, 18, 19, 20, 21, 22, 23, 24, 25],
    y_cmodel_mag = [17, 18, 19, 20, 21, 22, 23, 24, 25],
    W1 = [17, 18, 19, 20, 21]
)
